...
ᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/PKlinkzz_admin_bot">PKlinkzz_admin</a></b> 😏</b>"""
...
🔻 ɪғ ʏᴏᴜ ᴇɴᴄᴏᴜɴᴛᴇʀ ᴀɴʏ ɪssᴜᴇs sᴜᴄʜ ᴀs ᴛʜᴇ ʙᴏᴛ ɴᴏᴛ ʀᴇsᴘᴏɴᴅɪɴɢ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴜsᴇ ᴛʜᴇ /reset_grp ᴄᴏᴍᴍᴀɴᴅ. Iᴛ ᴡɪʟʟ ᴅᴇʟᴇᴛᴇ ᴀʟʟ ᴛʜᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴡʜɪᴄʜ ᴍᴇᴀɴs ʏᴏᴜ ᴡɪʟʟ ʜᴀᴠᴇ ᴛᴏ ᴠᴇʀɪғʏ ᴀɢᴀɪɴ ᴛᴏ ᴇɴᴀʙʟᴇ ғsᴜʙ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ</b>"""
    ...
    ABOUT_TXT = """<b>
 🤖 ᴍʏ ɴᴀᴍᴇ : {}
 👨‍💻 ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/PKlinkzz_admin_bot'>Admin</a>
...
<b>Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ : @PKlinkzz_admin_bot<b/>
"""
...
sɪᴢᴇ : {file_size}
Pʟᴇᴀsᴇ Fᴏʀᴡᴀʀᴅ Tʜɪs Fɪʟᴇ</a></b> Yᴏᴜ Wɪʟʟ Gᴇᴛ Fᴀsᴛ Dᴏᴡɴʟᴏᴀᴅ & Sᴛʀᴇᴀᴍ </a></b>"""
